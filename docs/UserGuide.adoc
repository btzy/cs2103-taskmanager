...
image::userguide/filterdemo_simplified.png[FilterDemo_Simplified, width="300",float=right]
...
image::FilterUnitDiagramUG.png[width="120",role="thumb right"]
...
image::FilterUnitDiagramSetUG.png[width="150",role="thumb right"]
