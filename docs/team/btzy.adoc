...
** Project management:
*** Contributed to user stories on GitHub issue tracker ([underline]#{1H}9#, [underline]#{1H}10#, [underline]#{1H}11#, [underline]#{1H}12#, [underline]#{1H}21#, [underline]#{1H}22#)
...
include::../UserGuide.adoc[tag=filter-simplified]
...
|===
|_For more explanation on using composition of filter predicates effectively, please visit our https://cs2103-ay1819s1-w17-4.github.io/main/UserGuide.html#composing-filter-predicates[user guide].  More examples are also available there._
|===

include::../UserGuide.adoc[tag=filter-set]

|===
|_For more examples, please visit our https://cs2103-ay1819s1-w17-4.github.io/main/UserGuide.html#composing-filter-predicates[user guide]._
|===

include::../UserGuide.adoc[tag=filter-errors]
...
include::../DeveloperGuide.adoc[tag=filter-unit-parser-extract]
...
include::../DeveloperGuide.adoc[tag=filter-unit-parser-diagram]

|===
|_More explanation on the "field identifier", "filter operator", "set operator", and "test phrase" are available in our https://cs2103-ay1819s1-w17-4.github.io/main/DeveloperGuide.html#filter-feature[developer guide].  Please follow the link for more information._
|===

include::../DeveloperGuide.adoc[tag=filter-error-messages]

|===
|_More explanation on the use of `TokenizationInvalidPredicateException` is available in our https://cs2103-ay1819s1-w17-4.github.io/main/DeveloperGuide.html#filter-feature[developer guide]._
|===
...
|===
|_Many of my contributions to the user guide have been omitted for brevity.  Please visit https://cs2103-ay1819s1-w17-4.github.io/main/DeveloperGuide.html#filter-feature[this link] for the full developer guide._
|===
